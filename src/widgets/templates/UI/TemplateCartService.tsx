...
const TemplateCartService = ({ data, select }: { data: Services, select?: Function }) => {
    return (
        <div className="mb-[9px]  flex gap-[15px] items-center ">
            ...
            <div className="grid grid-cols-[auto_auto_220px] gap-[10px] grow *:leading-[1.2]">
                <div className="rounded-[23px] bg-[#ECEEF1] p-[15px] flex items-center min-h-[97px]">
                    {data.type &&
