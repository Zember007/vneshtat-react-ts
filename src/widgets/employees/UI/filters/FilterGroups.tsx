        ...
        <>
            ...
            <div className="flex flex-col gap-[10px] max-h-full scroll ">
                {activeFilter === 'user' ?
                    (
                        <>
                            <span className='mt-[5px] font-medium'>Ответственный за группу</span>
                            ...
                            <span className='mt-[5px] font-medium'>Пассажиры</span>
                            <div className="flex flex-col gap-[6px] rounded-[23px] p-[13px] bg-[#ECEEF1]">
                            ...
                            <button className='rounded-[23px] border border-solid border-[#E5E7EA] p-[13px] flex justify-between items-center'>
                                <span className='text-[#787B86] text-[12px] font-normal'>Добавить пассажира</span>
