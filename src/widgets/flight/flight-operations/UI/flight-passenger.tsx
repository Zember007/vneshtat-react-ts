...
import { setPassengers } from "@/widgets/employees/model/index.store";

const FlightPassenger = () => {

    const [passengers, setPassengersUser] = useState<Passenger[]>([
        {
            id: 1,
            name: "Иван",
    ...
    return (
        <div className={"w-full"}>
            ...
            <div className="h-full flex flex-col justify-between">
                <SimpleBar className="max-h-[calc(100vh-423px)]">
                    <div className="  w-full flex flex-col py-2.5 gap-[10px]">
                        {passengers.map((passenger) => (
                            <PassengerItem delete={() => {
                                ...
                                setPassengersUser(remainingPassengers);
