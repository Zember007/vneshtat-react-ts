        ...
        <div className={"flex flex-row justify-center items-center"}>
            {employeeId ? (
                <div className={"pt-5 pb-10 flex flex-row gap-7 overflow-hidden w-full px-16 ultra:px-24"}>
                    ...
                    <div
                        className={`max-h-[calc(100vh-60px)] w-full flex flex-col gap-5 transition-all duration-300 ${isOpen ? "bg-[#1212121A] blur-md ml-[84px] ultra:ml-[110px]" : "ml-[84px] ultra:ml-[110px]"}`}>
                        <Header/>
                        {component}
                    </div>
                </div>
