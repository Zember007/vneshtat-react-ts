...
const BasicLayout = ({component}: { component: JSX.Element }) => {
    ...
    return (
        <div className={"flex flex-row justify-center"}>
            <div className={"pt-5 pb-10 flex flex-row gap-7 overflow-hidden w-full px-8 ultra:px-24"}>
                <div
                ...
                <div className={`absolute max-h-[calc(100vh-60px)] z-10 ${isOpen ? "w-[calc(100vw-84px)] ultra:w-[calc(100vw-128px)]" : "w-0"}`}>
                    ...
                    <div
                        className={`overflow-hidden transition-all ml-[240px] mt-[85px] ultra:ml-[280px] flex flex-col gap-4 ${isOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
                ...
                <div className={`max-h-[calc(100vh-60px)] w-full flex flex-col gap-5 transition-all duration-300 ${isOpen ? "bg-[#1212121A] blur-md" : "ml-[84px] ultra:ml-[110px]"}`}>
                    <Header/>
                    {component}
                </div>
            </div>
