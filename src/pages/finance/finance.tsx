...
import { Assets } from "@/widgets/finance/assets";
import Infornation from '@/widgets/finance/UI/Information';
 ...
 */
    ...
    const links = [
        { title: 'Активы', to: '/jobs/finance/banks' },
        ...
        <>
            ...
            <div className="flex gap-[15px] h-full">
                <div className="flex flex-col gap-[15px] grow h-full">
                    ...
                    {
                        location.includes('/jobs/finance/banks') && <Assets />
                    }
